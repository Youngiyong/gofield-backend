kill `ps -ef | grep "/opt/gofield/gofield-backend-deploy/gofield-api-user-service/build/libs/gofield-api-user-service.jar" | grep -v grep | awk '{print $2}'`
kill `ps -ef | grep "/opt/gofield/gofield-backend-deploy/gofield-admin/build/libs/gofield-admin.jar" | grep -v grep | awk '{print $2}'`
kill `ps -ef | grep "/opt/gofield/gofield-backend-deploy/gofield-sns/build/libs/gofield-sns.jar" | grep -v grep | awk '{print $2}'`
