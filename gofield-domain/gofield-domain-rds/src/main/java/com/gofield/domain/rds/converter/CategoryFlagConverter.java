...
@Converter
public class CategoryFlagConverter implements AttributeConverter<ECategoryFlag, String> {

    @Override
    public String convertToDatabaseColumn(ECategoryFlag attribute) {
        if(attribute==null){
    ...
    @Override
    public ECategoryFlag convertToEntityAttribute(String dbData) {
        ...
        return ECategoryFlag.ofCode(dbData);
    }
}
