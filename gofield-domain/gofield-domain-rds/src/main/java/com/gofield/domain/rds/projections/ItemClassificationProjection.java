...
public class ItemClassificationProjection {
    ...
    @QueryProjection
    public ItemClassificationProjection(Long id, String itemNumber, String brandName, String thumbnail, int price, Long likeId, EItemClassificationFlag classification, EItemGenderFlag gender, String option) {
        this.id = id;
