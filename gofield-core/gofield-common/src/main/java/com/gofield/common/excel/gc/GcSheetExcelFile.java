package com.gofield.common.excel.gc;

import com.fasterxml.jackson.core.type.TypeReference;
import com.gofield.common.excel.PivotExcelFile;
...
public final class GcSheetExcelFile<T> extends PivotExcelFile<T> {
	...
	public void renderExcel(Object data) {
		...
		Object sourceData = JsonUtils.strToObject(JsonUtils.toJsonStr(data), new TypeReference<Object[][]>() {});
