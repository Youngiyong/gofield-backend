package com.gofield.common.excel.utils;

import com.gofield.common.excel.annotation.PivotEnumModel;
import com.gofield.common.excel.gc.resource.ExcelRenderGcResourceFactory;
...
public final class SuperClassReflectionUtils {
	...
	public static List<Map<String, Object>> getPivotEnumClassFieldOrientations(Class<?> clazz) {
		...
		if (null == pivotEnumModels) {
			throw new ExcelException("pivotEnumModels is null !!", new NullPointerException());
		}
