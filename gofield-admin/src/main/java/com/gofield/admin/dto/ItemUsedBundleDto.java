...
@Setter
@NoArgsConstructor
public class ItemUsedBundleDto {
    private Long id;
    ...
    @Builder
    private ItemUsedBundleDto(Long id, List<CategoryDto> categoryList, List<BrandDto> brandList,  Long bundleId, Long brandId, Long categoryId, Long detailId, Long shippingTemplateId, String name, String itemNumber,
    ...
    public static ItemUsedBundleDto of(List<CategoryDto> categoryList, List<BrandDto> brandList){
        return ItemUsedBundleDto.builder()
    ...
    public static ItemUsedBundleDto of(List<CategoryDto> categoryList, List<BrandDto> brandList, Item item, ItemStock itemStock, List<ItemOptionProjection> optionList){
