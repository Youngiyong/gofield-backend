...
public class OrderCancelDto {
    ...
    @Builder
    private OrderCancelDto(Long id, String orderNumber, String orderDate, String status, String cancelDate, String comment, String name,
                           String optionName, int price, int qty, String customerTel, String customerName,
                           String address, String addressExtra, String zipCode){
        this.id = id;
    ...
    public static OrderCancelDto of(OrderCancel orderCancel){
        ...
        int price = orderCancelItem.getQty();
